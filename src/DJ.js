...
class DJ {
  ...
  */
  walkJSONString (
    str, parentObject, parentKey, parentObjectArrayBool
  ) {
  ...
  */
  ...
  delegateHandlersByType (obj, parentObject, parentKey, parentObjectArrayBool) {
    ...
    const type = this.detectBasicType(
    ...
    case 'null': case 'undefined':
      return this.delegateHandlers(
        type + suffix, parentObject, parentKey, parentObjectArrayBool
      );
...
function DJ_JS (options) {
  ...
  var newOpts = _copyObject(options);
...
if (typeof module !== 'undefined') {
  DJ.Stringifier = require('./DJ.Stringifier');
  DJ.ObjectArrayDelegator = require('./DJ.ObjectArrayDelegator');
}
