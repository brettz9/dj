...
var djTests = {
    'basic test': function (test) {
        ...
        test.strictEqual('["childItem","childWith\\"Dbl\\"Quotes"]', sf.walkJSONObject(['childItem', 'childWith"Dbl"Quotes']));

        test.strictEqual('{"a":null,"b":true,"c":3,"d":["childItem","childWith\\"Dbl\\"Quotes"],"e":{"nested":true},"f":null}',
            sf.walkJSONObject({a: null, b: true, c: 3, d: ['childItem', 'childWith"Dbl"Quotes'], e: {nested: true}, f: Infinity})
        );

        test.strictEqual('{"a":null,"b":true,"c":3,"d":["childItem","childWith\\"Dbl\\"Quotes"],"e":{"nested":true},"f":Infinity,"g":undefined,"h":function () {}}',
