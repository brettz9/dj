...
* This class uses the abstract DJ.ObjectArrayDelegator for object/array delegating so the stringification can occur solely on the terminal methods here
* @todo Could implement our own stringifier for strings rather than using JSON.stringify
*/
var require, DJ, module;
(function () {'use strict';
...
var Stringifier = DJ.createConstructor(DJ.ObjectArrayDelegator); // Convenience method to create constructor not requiring new keyword and inheriting from the designated constructor (or DJ when not present)
