...
var Stringifier = DJ.createConstructor(ObjectArrayDelegator); // Convenience method to create constructor not requiring new keyword and inheriting from the designated constructor (or DJ when not present)
...
DJ.exportClass(Stringifier, 'Stringifier');
